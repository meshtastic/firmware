...
USER root
RUN apt-get update && \
	apt-get -y install wget python3 g++ zip python3-venv git vim ca-certificates libgpiod-dev libyaml-cpp-dev libbluetooth-dev libg	piod2 openssl libssl-dev libulfius-dev liborcania-dev bash
