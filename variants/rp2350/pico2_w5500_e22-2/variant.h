...
//
// *** "-2" variant: W5500 SPI0 pins fully relocated (GP16-20 suspected damaged) ***
//
...
//
// W5500 Ethernet on SPI0 (all relocated):
//   MISO=GP20  CS=GP21  SCK=GP22  MOSI=GP7  RST=GP6
//
...
// Optional user button — GP6 is used for W5500 RST in this "-2" variant,
// so it is NOT available for a button here (unlike the original variant).
// #define BUTTON_PIN 6
...
// ---- W5500 Ethernet on SPI0 (fully relocated) --------------------------
// All SPI0 pins moved to alternate SPI0-capable GPIOs:
//   GP20 = SPI0 RX   (MISO, was GP16)
//   GP22 = SPI0 SCK  (was GP18)
//   GP7  = SPI0 TX   (MOSI, was GP19) — GP23 is internal on Pico 2
