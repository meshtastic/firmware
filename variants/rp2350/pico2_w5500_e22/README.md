...
Conectar el módulo W5500 a estos pines:

| Señal W5500 | GPIO Pico 2 | Cable  |
|-------------|-------------|--------|
| MISO        | GP16        | amarillo |
| CS / SCS    | GP17        | naranja  |
| SCK         | GP18        | verde    |
...
> SPI0 queda reservado para el W5500.
...
- SPI0 se inicializa explícitamente con pines GP16/18/19 antes de `Ethernet.init()`.
