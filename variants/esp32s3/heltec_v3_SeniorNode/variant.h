// ====== Variant definition for my Heltec_v3_SeniorNode board ====== //
//
...
// Explicit polarity macros: 1 = active-low, 0 = active-high
#define RedLED_ACTIVE_LOW 1
#define GreenLED_ACTIVE_LOW 1
#define BlueLED_ACTIVE_LOW 1
