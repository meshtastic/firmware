...
#define RADIO_NSS SX126X_CS    // Compatibility with variant file configuration structure
#define SPI_SCK SX126X_SCK   // Compatibility with variant file configuration structure
#define SPI_MOSI SX126X_MOSI // Compatibility with variant file configuration structure
#define SPI_MISO SX126X_MISO // Compatibility with variant file configuration structure
