...
#ifndef _VARIANT_DELTA_HP_
#define _VARIANT_DELTA_HP_

#define RAK4630

// Edict HP trimmed feature set: no display, GPS, local input, or onboard sensors.
#define HAS_SCREEN 0
#define HAS_TFT 0
#define HAS_GPS 0
#define HAS_BUTTON 0
...
/* @note Base-board GPIO mapping reference
  Base board <-> nRF52840
...
* Some base schematics show GPIO P1.07 connected to the antenna switch, but it should not be initialized, as DIO2 will do the
...
// Configure the SET pin on compatible soil/air-quality sensor boards to disable the sensor while not reading
// air quality telemetry.  PIN_NFC2 doesn't seem to be used anywhere else in the codebase, but if
// you're having problems with your node behaving weirdly when the optional board isn't connected,
// try disabling this.
...
// GPS is intentionally disabled for Edict HP right now (HAS_GPS=0).
// Keep these pin mappings as a reference for future bring-up.
// #define PIN_GPS_PPS (17)
// #define GPS_RX_PIN PIN_SERIAL1_RX
// #define GPS_TX_PIN PIN_SERIAL1_TX

// Edict HP custom ringtone
#undef USERPREFS_RINGTONE_RTTTL
#define USERPREFS_RINGTONE_RTTTL "Edict:d=32,o=5,b=200:b7,p,b7,4p,p"
...
// Base board AIN0 = nrf52840 AIN3 = Pin 5
