...
NicheGraphics setup for Heltec Mesh Pocket (LCMEN2R13ECC1 2.13" on SPI1).
Shared by both BaseUI and InkHUD envs (5000 and 10000 mAh variants).
...
#include "graphics/eink/Panels/LCMEN2R13ECC1.h"
...
void setupNicheGraphics()
{
    ...
    auto *panel = new Panels::LCMEN2R13ECC1();
...
{
    auto *panel = new NicheGraphics::Panels::LCMEN2R13ECC1();
