...
// GAT562 Mesh Tracker Pro (GAT-IoT): gat562_mesh_trial_tracker plus a 5-way joystick
// (HAS_TRACKBALL); no external QSPI flash, since the joystick occupies those pins.
...
// The side button is Cancel/Back; Select is the joystick press.
#define CANCEL_BUTTON_PIN 9
#define BUTTON_NEED_PULLUP
#define CANCEL_BUTTON_ACTIVE_LOW true
#define CANCEL_BUTTON_ACTIVE_PULLUP false

// 5-way joystick, driven by InputBroker as a trackball.
...
// No external QSPI flash: the trial tracker's QSPI pins 26/28/30 are the joystick here,
// so EXTERNAL_FLASH_* stay undefined and LittleFS uses internal flash.
