...
// voltages are set by the SPI voltage (47, 48), and pins that don't exist (22-25) You can ALSO set the SPI pins (E22_SCK,
// E22_MOSI, E22_MISO, E22_NRST) to any pin with the ESP32-S3 due to \ GPIO Matrix / IO MUX / RTC IO MUX \, and also the serial
// pins, but this isn't recommended for Serial0 as the WROOM modules have a 499 Ohm resistor on U0TXD (to reduce harmonics but
// also acting as a sort of protection)
...
#define SX126X_CS 14    // E22's NSS pin
#define SX126X_SCK 21   // E22's SCK pin
#define SX126X_MOSI 38  // E22's MOSI pin
#define SX126X_MISO 39  // E22's MISO pin
#define SX126X_RESET 40 // E22's NRST pin
#define SX126X_BUSY 41  // E22's BUSY pin
#define SX126X_DIO1 42  // E22's DIO1 pin
