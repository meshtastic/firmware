...
// The destination's RF settings ride on the target that uses them; the channel above is the
// by-value default this target inherits, because it names no index of its own.
