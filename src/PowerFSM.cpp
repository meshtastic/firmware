...
void PowerFSM_setup()
{
    ...
    // Handle alt press events - note: we ignore button presses when in API mode
    ...
    powerFSM.add_transition(&stateSERIAL, &stateSERIAL, EVENT_PRESS_ALT, screenPress, "Press"); // Allow button to work while in serial API
