...
TinyGPSPlus::TinyGPSPlus()
    ...
    : parity(0), flags(FLAG_DEFAULT), curSentenceType(GPS_SENTENCE_OTHER), curTermNumber(0), curTermOffset(0), fixQ(0)
      ...
      ,
      customElts(0), customCandidates(0), customElts(0), customCandidates(0)
#endif
#ifndef TINYGPSPLUS_OPTION_NO_STATISTICS
      ,
      encodedCharCount(0), sentencesWithFixCount(0), failedChecksumCount(0), passedChecksumCount(0), encodedCharCount(0),
                ...
                if (checksum == parity) {
                    ...
                    case GPS_SENTENCE_GGA:
                        ...
                        case GPS_SENTENCE_ZDA:
                            ...
                            zdaInfo.valid = pendingZDAYear >= 2000 && pendingZDAMonth >= 1 && pendingZDAMonth <= 12 &&
                ...
                case 16: {
                    ...
                    if (termIsNotEmpty) {
                        ...
                        if (termIsNotEmpty) {
                            ...
                            for (size_t i = 0; i < TINYGPS_MAX_SATS; ++i) {
                                if (trackedSatellites[i].prn == prn && trackedSatellites[i].system == currentGSVSystem) {
