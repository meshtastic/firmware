...
#define RDEF(name, freq_start, freq_end, duty_cycle, spacing, power_limit, text_throttle, position_throttle, telemetry_throttle, \
             audio_permitted, frequency_switching, wide_lora, licensed_only, override_slot, default_preset, available_presets)   \
    {                                                                                                                            \
        meshtastic_Config_LoRaConfig_RegionCode_##name, freq_start, freq_end, duty_cycle, spacing, power_limit, text_throttle,   \
            position_throttle, telemetry_throttle, audio_permitted, frequency_switching, wide_lora, licensed_only,               \
            override_slot, meshtastic_Config_LoRaConfig_ModemPreset_##default_preset, available_presets, #name                   \
    }
...
const RegionInfo regions[] = {
    ...
    */
    RDEF(US, 902.0f, 928.0f, 100, 0, 30, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
     ...
     */
    RDEF(EU_433, 433.0f, 434.0f, 10, 0, 10, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
     ...
     */
    RDEF(EU_868, 869.4f, 869.65f, 10, 0, 27, false, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_EU_868),

    /*
        https://lora-alliance.org/wp-content/uploads/2020/11/lorawan_regional_parameters_v1.0.3reva_0.pdf
     */
    RDEF(CN, 470.0f, 510.0f, 100, 0, 19, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
     ...
     */
    RDEF(JP, 920.5f, 923.5f, 100, 0, 13, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    /*
        ...
        Also used in Brazil.
     */
    RDEF(ANZ, 915.0f, 928.0f, 100, 0, 30, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
     ...
     */
    RDEF(ANZ_433, 433.05f, 434.79f, 100, 0, 14, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
     ...
     */
    RDEF(RU, 868.7f, 869.2f, 100, 0, 20, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),

    /*
        https://www.law.go.kr/LSW/admRulLsInfoP.do?admRulId=53943&efYd=0
        https://resources.lora-alliance.org/technical-specifications/rp002-1-0-4-regional-parameters
     */
    RDEF(KR, 920.0f, 923.0f, 100, 0, 23, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
     ...
     */
    RDEF(TW, 920.0f, 925.0f, 100, 0, 27, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    /*
       https://lora-alliance.org/wp-content/uploads/2020/11/lorawan_regional_parameters_v1.0.3reva_0.pdf
    */
    RDEF(TH, 920.0f, 925.0f, 100, 0, 16, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),

    /*
        433,05-434,7 Mhz 10 mW
        https://nkrzi.gov.ua/images/upload/256/5810/PDF_UUZ_19_01_2016.pdf
    */
    RDEF(UA_433, 433.0f, 434.7f, 10, 0, 10, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),

    /*
        868,0-868,6 Mhz 25 mW
        https://nkrzi.gov.ua/images/upload/256/5810/PDF_UUZ_19_01_2016.pdf
    */
    RDEF(UA_868, 868.0f, 868.6f, 1, 0, 14, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    RDEF(MY_433, 433.0f, 435.0f, 100, 0, 20, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    /*
        ...
        https://www.mcmc.gov.my/skmmgovmy/media/General/pdf/Short-Range-Devices-Specification.pdf
    */
    RDEF(MY_919, 919.0f, 924.0f, 100, 0, 27, true, true, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    RDEF(SG_923, 917.0f, 925.0f, 100, 0, 20, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    ...
    RDEF(PH_433, 433.0f, 434.7f, 100, 0, 10, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    RDEF(PH_868, 868.0f, 869.4f, 100, 0, 14, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    RDEF(PH_915, 915.0f, 918.0f, 100, 0, 24, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    RDEF(KZ_433, 433.075f, 434.775f, 100, 0, 10, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    RDEF(KZ_863, 863.0f, 868.0f, 100, 0, 30, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    RDEF(NP_865, 865.0f, 868.0f, 100, 0, 30, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    RDEF(BR_902, 902.0f, 907.5f, 100, 0, 30, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),
    ...
    */
    RDEF(EU_866, 865.6375f, 867.5625f, 2.5, 0.475, 27, false, false, false, false, 0, 99, 99, 0, LITE_FAST, PRESETS_LITE),
    ...
    */
    RDEF(NARROW_868, 869.4f, 869.65f, 10, 0.015, 27, false, false, false, false, 0, 0, 0, 1, NARROW_FAST, PRESETS_NARROW),

    /*
       2.4 GHZ WLAN Band equivalent. Only for SX128x chips.
    */
    RDEF(LORA_24, 2400.0f, 2483.5f, 100, 0, 10, true, false, true, false, 0, 0, 0, 0, LONG_FAST, PRESETS_STD),

    /*
        This needs to be last. Same as US.
    */
    RDEF(UNSET, 902.0f, 928.0f, 100, 0, 30, true, false, false, false, 0, 0, 0, 0, LONG_FAST, PRESETS_UNDEF)
