...
class RadioLibInterface : public RadioInterface, protected concurrency::NotifiedWorkerThread
{
  ...
  public:
    ...
    /** True where DIO1 is only seen through libch341's pin poll (a CH341 USB host), so an interrupt arrives
     *  up to one poll interval plus a USB read after the chip raised it. */
