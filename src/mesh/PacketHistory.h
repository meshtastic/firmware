...
#define PACKETHISTORY_MAX (int)(MAX_NUM_NODES * 2.0) // x2..3  Should suffice. Empirical setup. 16B per record malloc'ed.
#define FLOOD_EXPIRE_TIME (10 * 60 * 1000L) // Is this needed anymore? If not set to 0.  No change for fuzzing. Should withstand.
