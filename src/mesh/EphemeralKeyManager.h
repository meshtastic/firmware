 ...
 */
#ifdef PFS_TEST_MODE
#define DEFAULT_EPHEMERAL_KEY_ROTATION_MESSAGES 5 // Rotate after 5 messages for testing
#else
...
public:
   ...
   */
  void setRemoteKey(uint32_t nodeNum, const uint8_t *pubkey, uint32_t keyId, uint32_t timestamp);
   ...
   */
  uint32_t getRotationThreshold() const { return DEFAULT_EPHEMERAL_KEY_ROTATION_MESSAGES; }
