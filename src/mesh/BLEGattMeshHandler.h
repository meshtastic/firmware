 ...
 * the mesh characteristic and subscribes to it. The liveness probe and the HELLO election cover a
 * link this node dialled itself, which no platform here does yet: the hooks keep their defaults.
 *
