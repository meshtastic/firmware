...
#define meshtastic_LocalModuleConfig_wireguard_tag 15
...
X(a, STATIC,   OPTIONAL, MESSAGE,  wireguard,        15)
...
#define meshtastic_LocalModuleConfig_size        1071
