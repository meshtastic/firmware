...
#define meshtastic_LocalModuleConfig_traffic_management_tag 15
...
X(a, STATIC,   OPTIONAL, MESSAGE,  traffic_management,  15)
...
#define meshtastic_LocalModuleConfig_size        731
