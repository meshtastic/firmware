...
#define meshtastic_ModuleConfig_MQTTConfig_secure_messages_tag 12
...
X(a, STATIC,   SINGULAR, BOOL,     secure_messages,  12)
...
#define meshtastic_ModuleConfig_MQTTConfig_size  256
