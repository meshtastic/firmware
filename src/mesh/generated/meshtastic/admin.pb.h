...
typedef PB_BYTES_ARRAY_T(32) meshtastic_AdminMessage_ota_hash_t;
...
typedef struct _meshtastic_AdminMessage {
    ...
    union {
     ...
     Used to verify the integrity of the firmware before applying an update. */
        meshtastic_AdminMessage_ota_hash_t ota_hash;
    };
...
#define meshtastic_AdminMessage_ota_hash_tag     102
...
X(a, STATIC,   ONEOF,    BYTES,    (payload_variant,ota_hash,ota_hash), 102)
