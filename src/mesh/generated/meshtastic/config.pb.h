...
typedef struct _meshtastic_Config_DeviceConfig {
 ...
 Defaults to ENABLED */
    ...
    /* If OUTPUT_GPIO_PIN is defined in the board variant, setting this to true drives that pin HIGH.
 Setting it to false drives the pin LOW. */
    bool output_gpio_enabled;
...
#define meshtastic_Config_DeviceConfig_output_gpio_enabled_tag 14
...
X(a, STATIC,   SINGULAR, BOOL,     output_gpio_enabled,  14)
