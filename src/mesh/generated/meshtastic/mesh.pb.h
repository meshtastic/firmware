...
typedef PB_BYTES_ARRAY_T(32) meshtastic_User_ephemeral_pubkey_t;
...
typedef struct _meshtastic_User {
 ...
 This is sent out to other nodes on the mesh to allow them to compute a shared secret key. */
    ...
    /* Ephemeral public key for Perfect Forward Secrecy.
 This key is rotated periodically to ensure past messages cannot be decrypted
 even if the long-term private key is compromised. */
    meshtastic_User_ephemeral_pubkey_t ephemeral_pubkey;
    /* Identifier for the current ephemeral key.
 Incremented each time the ephemeral key is rotated.
 Used by recipients to track which ephemeral key was used. */
    uint32_t ephemeral_key_id;
    /* Timestamp (seconds since epoch) when the ephemeral key was generated.
 Used for key age validation and rotation decisions. */
    uint32_t ephemeral_key_timestamp;
} meshtastic_User;
...
#define meshtastic_User_init_default             {"", "", "", {0}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {0, {0}}, false, 0, {0, {0}}, 0, 0}
...
#define meshtastic_User_init_zero                {"", "", "", {0}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {0, {0}}, false, 0, {0, {0}}, 0, 0}
...
#define meshtastic_User_ephemeral_pubkey_tag     10
#define meshtastic_User_ephemeral_key_id_tag     11
#define meshtastic_User_ephemeral_key_timestamp_tag 12
...
X(a, STATIC,   SINGULAR, BYTES,    ephemeral_pubkey,  10) \
X(a, STATIC,   SINGULAR, UINT32,   ephemeral_key_id,  11) \
X(a, STATIC,   SINGULAR, FIXED32,  ephemeral_key_timestamp,  12)
...
#define meshtastic_NodeInfo_size                 369
...
#define meshtastic_User_size                     160
