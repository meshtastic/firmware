...
typedef struct _User { 
 ...
 This is used for direct message payload encryption. */
...
#define User_init_default                        {"", "", "", {0}, _HardwareModel_MIN, 0, _Team_MIN, 0, 0, 0, {0}}
...
#define User_init_zero                           {"", "", "", {0}, _HardwareModel_MIN, 0, _Team_MIN, 0, 0, 0, {0}}
