 ...
 */
bool CryptoEngine::deriveTripleDHSessionKey(const uint8_t *remoteIdentityPub, const uint8_t *remoteEphemeralPub,
                                            const uint8_t *localEphemeralPriv, uint8_t *sessionKeyOut)
{
...
bool CryptoEngine::encryptWithPFS(uint32_t toNode, uint32_t fromNode, meshtastic_UserLite_public_key_t remoteIdentityKey,
                                  const uint8_t *remoteEphemeralKey, uint64_t packetNum, size_t numBytes, const uint8_t *bytes,
                                  uint8_t *bytesOut)
{
 ...
 */
bool CryptoEngine::decryptWithPFS(uint32_t fromNode, meshtastic_UserLite_public_key_t remoteIdentityKey,
                                  const uint8_t *remoteEphemeralKey, uint64_t packetNum, size_t numBytes, const uint8_t *bytes,
                                  uint8_t *bytesOut)
{
    extern EphemeralKeyManager *ephemeralKeyMgr;
