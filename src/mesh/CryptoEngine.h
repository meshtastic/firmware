...
class CryptoEngine
{
  public:
    ...
    virtual bool decryptCurve25519(uint32_t fromNode, meshtastic_UserLite_public_key_t remotePublic, uint32_t packetNum,
  ...
  protected:
     ...
     * a 32 bit optional (defaults to 0) extra nonce node number (stored in little endian order)
