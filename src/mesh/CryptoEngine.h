...
class CryptoEngine
{
  public:
    ...
    virtual bool deriveTripleDHSessionKey(const uint8_t *remoteIdentityPub, const uint8_t *remoteEphemeralPub,
    ...
    virtual bool encryptWithPFS(uint32_t toNode, uint32_t fromNode, meshtastic_UserLite_public_key_t remoteIdentityKey,
                                ...
                                uint8_t *bytesOut);
    virtual bool decryptWithPFS(uint32_t fromNode, meshtastic_UserLite_public_key_t remoteIdentityKey,
                                const uint8_t *remoteEphemeralKey, uint64_t packetNum, size_t numBytes, const uint8_t *bytes,
                                uint8_t *bytesOut);
