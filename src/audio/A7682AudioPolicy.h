...
inline uint8_t a7682AudioVolumeFromPreference(const A7682AudioPreferenceRecord &record, size_t bytesRead)
{
    return isValidA7682AudioPreferenceRecord(record, bytesRead) ? record.volume : A7682_AUDIO_DEFAULT_VOLUME;
}
