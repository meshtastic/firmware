 ...
 * latched an interrupt (typically an RX_DONE). If that edge lands in the small window between
 * enableLoraInterrupt() and esp_light_sleep_start(), the DIO ISR fires and detachInterrupt() clears
