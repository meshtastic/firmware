...
uint8_t MCP23017_KeyMap[16] = {
    MCP23017_KEYMAP_0,  MCP23017_KEYMAP_1,  MCP23017_KEYMAP_2,
    MCP23017_KEYMAP_3,  MCP23017_KEYMAP_4,  MCP23017_KEYMAP_5,
    MCP23017_KEYMAP_6,  MCP23017_KEYMAP_7,  MCP23017_KEYMAP_8,
    MCP23017_KEYMAP_9,  MCP23017_KEYMAP_10, MCP23017_KEYMAP_11,
    MCP23017_KEYMAP_12, MCP23017_KEYMAP_13, MCP23017_KEYMAP_14,
    MCP23017_KEYMAP_15};

MCP23017Keyboard::MCP23017Keyboard()
    : m_wire(nullptr), m_addr(0), readCallback(nullptr),
...
bool MCP23017Keyboard::hasEvent() { return queue.length() > 0; }
...
void MCP23017Keyboard::trigger() {
  ...
  if (state != Init) {
    uint16_t keyRegister = readRegister16(
        _MCP23017_GPIOA); // Read the state of all 16 pins (GPIO A & B)
