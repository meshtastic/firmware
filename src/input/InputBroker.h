...
((input_broker_event) == INPUT_BROKER_SELECT_LONG || \
(input_broker_event) == INPUT_BROKER_UP_LONG || \
(input_broker_event) == INPUT_BROKER_DOWN_LONG || \
(input_broker_event) == INPUT_BROKER_ALT_LONG)
