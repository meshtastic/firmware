...
void AtakPluginModule::alterReceivedProtobuf(meshtastic_MeshPacket &mp, meshtastic_TAKPacket *t)
{
    ...
    if (mp.from == 0) {
        ...
        // auto length =
        //     unishox2_compress_simple(t->contact.callsign_variant.callsign_uncompressed,
        //     sizeof(t->contact.callsign_variant.callsign_uncompressed),
        //                              compressed.contact.callsign_variant.callsign_compressed);
        // memset(compressed.contact.callsign_variant.callsign_uncompressed, '\0',
        // strlen(compressed.contact.callsign_variant.callsign_uncompressed)); LOG_DEBUG("Uncompressed callsign %d bytes\n",
        // strlen(t->contact.callsign_variant.callsign_uncompressed)); LOG_DEBUG("Compressed callsign %d bytes\n", length);
        ...
        // auto length = unishox2_decompress_simple(t->contact.callsign_variant.callsign_compressed,
        ...
        // length); service.sendToPhone(decompressedCopy);
    }
    return;
}