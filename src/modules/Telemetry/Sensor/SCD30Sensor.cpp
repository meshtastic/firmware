...
// protobuf no longer exposes a dedicated SCD30 enum in this branch, so use SCD4X as the closest CO2 sensor category.
                                                         ...
                                                         meshtastic_AdminMessage *response)
{
    ...
    case meshtastic_AdminMessage_sensor_config_tag:
#ifdef meshtastic_SensorConfig_scd30_config_tag
        ...
        if (request->sensor_config.scd30_config.has_soft_reset) {
            ...
            // Check for set measurement interval
...
#else
        // This branch's protobuf schema does not include SCD30 admin fields.
        result = AdminMessageHandleResult::NOT_HANDLED;
#endif
        break;
