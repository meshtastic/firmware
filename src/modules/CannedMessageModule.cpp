...
int CannedMessageModule::handleInputEvent(const InputEvent *event) {
  ...
  case CANNED_MESSAGE_RUN_STATE_INACTIVE:
    ...
    if (event->inputEvent == INPUT_BROKER_UP || event->inputEvent == INPUT_BROKER_DOWN || event->inputEvent == INPUT_BROKER_ALT_LONG) {
...
bool CannedMessageModule::shouldDraw() { return (currentMessageIndex != -1) || (this->runState != CANNED_MESSAGE_RUN_STATE_INACTIVE); }
