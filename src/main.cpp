...
// Two supported RGB LED currently
    ...
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::MMC5983MA, meshtastic_TelemetrySensorType_CUSTOM_SENSOR);
    scannerToSensorsMap(i2cScanner, ScanI2C::DeviceType::ICM42607P, meshtastic_TelemetrySensorType_CUSTOM_SENSOR);
