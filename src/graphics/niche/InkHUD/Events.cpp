...
void InkHUD::Events::onButtonShort()
{
    ...
    if (consumer) {
        ...
        if (userConsumer->isInputEnabled(Applet::BUTTON_SHORT))
...
void InkHUD::Events::onButtonLong()
{
    ...
    if (consumer)
        ...
        if (userConsumer->isInputEnabled(Applet::BUTTON_LONG))
...
void InkHUD::Events::onExitShort()
{
    if (settings->joystick.enabled) {
        ...
        if (consumer)
            ...
            if (userConsumer->isInputEnabled(Applet::EXIT_SHORT))
...
void InkHUD::Events::onExitLong()
{
    if (settings->joystick.enabled) {
        ...
        if (consumer)
            ...
            if (userConsumer->isInputEnabled(Applet::EXIT_LONG))
...
void InkHUD::Events::onNavUp()
{
    if (settings->joystick.enabled) {
        ...
        if (consumer)
            ...
            if (userConsumer->isInputEnabled(Applet::NAV_UP))
...
void InkHUD::Events::onNavDown()
{
    if (settings->joystick.enabled) {
        ...
        if (consumer)
            ...
            if (userConsumer->isInputEnabled(Applet::NAV_DOWN))
...
void InkHUD::Events::onNavLeft()
{
    if (settings->joystick.enabled) {
        ...
        if (consumer)
            ...
            if (userConsumer->isInputEnabled(Applet::NAV_LEFT))
...
void InkHUD::Events::onNavRight()
{
    if (settings->joystick.enabled) {
        ...
        if (consumer)
            ...
            if (userConsumer->isInputEnabled(Applet::NAV_RIGHT))
