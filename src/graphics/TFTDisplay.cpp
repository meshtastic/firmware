...
#include <LovyanGFX.hpp> // Graphics and font library for ILI9342 driver chip

#if defined(ILI9342_BACKLIGHT_EN) && !defined(TFT_BL)
#define TFT_BL ILI9342_BACKLIGHT_EN
#endif
