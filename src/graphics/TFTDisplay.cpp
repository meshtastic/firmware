...
#elif defined(HACKADAY_COMMUNICATOR) || defined(HELTEC_RC52)
...
#if defined(HACKADAY_COMMUNICATOR) || defined(HELTEC_RC52)
...
void TFTDisplay::sendCommand(uint8_t com)
{
    ...
    !defined(HACKADAY_COMMUNICATOR) && !defined(HELTEC_RC52) // T-Deck gets brightness set in Screen.cpp in the handleSetOn function
...
#endif
#if defined(RAK14014) || defined(HELTEC_MESH_NODE_T096) || defined(HELTEC_MESH_NODE_T1)
#elif !defined(M5STACK) && !defined(HACKADAY_COMMUNICATOR) && !defined(HELTEC_RC52)
        tft->setBrightness(0);
#endif
        break;
    }
...
#ifdef RAK14014
    return true;
#elif !defined(M5STACK) && !defined(HACKADAY_COMMUNICATOR) && !defined(HELTEC_RC52) && !defined(HELTEC_MESH_NODE_T096) &&         \
    !defined(HELTEC_MESH_NODE_T1)
...
bool TFTDisplay::connect()
{
    ...
    if (!tft) {
        ...
        Arduino_DataBus *bus = new Arduino_HWSPI(TFT_RS, TFT_CS, &SPI1, true);
        tft = new Arduino_NV3001B(bus, TFT_RST, 3 /* rotation */, true /* IPS */, TFT_WIDTH, TFT_HEIGHT, 0, 0, 0, 0);
#else
        tft = new LGFX;
#endif
    }
